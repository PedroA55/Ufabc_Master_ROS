...
plt.grid()
plt.legend(['x(t) desejado','x(t) real'])
plt.subplot(3,1,2)
...
plt.legend(['y(t) desejado','y(t) real'])
frame2 = plt.gca()
...
plt.legend(['z(t) desejado','z(t) real'])
plt.grid()
plt.xlabel('tempo')
...
plt.legend(['$v_x$(t) desejado','$v_x$(t) real'])
...
plt.legend(['$v_y$(t) desejado','$v_y$(t) real'])
frame2 = plt.gca()
frame2.axes.xaxis.set_ticklabels([])
#frame2.axes.get_xaxis().set_visible(False)
#frame2.axes.get_xaxis().set_visible(False)
...
plt.legend(['$v_z$(t) desejado','$v_z$(t) real'])
plt.grid()
plt.xlabel('tempo')
...
plt.legend(['$\phi$(t) desejado','$\phi$(t) comando','$\phi$(t) real'])
frame1 = plt.gca()
frame1.axes.xaxis.set_ticklabels([])
#frame1.axes.get_xaxis().set_ticks([])
#frame1.axes.get_xaxis().set_visible(False)
...
plt.legend(['$\\theta$(t) desejado','$\\theta$(t) comando','$\\theta$(t) real'])
frame2 = plt.gca()
frame2.axes.xaxis.set_ticklabels([])
#frame2.axes.get_xaxis().set_visible(False)
#frame2.axes.get_xaxis().set_visible(False)
